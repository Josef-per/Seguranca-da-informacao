...
{
    Console.WriteLine($"Com os segmentos {r1.ToString("F1")} - {r2.ToString("F1")} - {r3.ToString("F1")} é possivel fazer um triangulo");
    if (r1 == r2 && r1 == r3 && r3 == r2)
    {
        Console.Write("Tipo: Equilátero");
    }
    else if (r1 == r2 || r1 == r3 || r2 == r3)
    {
        Console.Write("Tipo: Isóceles");
    }
    else
    {
